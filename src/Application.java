...
public class Application {
  ...
  public static void main(String[] args) {
    ...
    //System.out.println(array[6]); you get an error saying 6 is out of bounds
    
    //print out the element in the array at position -1. what happens?
    //System.out.println(array[-1]); you get an error saying -1 is out of bounds
    
    //write a traditional for loop that prints out each element of the array
    for(int i = 0; i < array.length; i++) {
      System.out.println(array[i]);
    }
    
    //write an enhanced for loop that prints out each element of the array
    ...
    //The first method will just do something and the second method will return something
    ...
    //write and test a method that takes an array of Strings and returns an array of int where each element matches the length of the string at the position
    int[] nameLengths = extractStringLengths(names);
    for (int number : nameLengths) {
      System.out.println(number);
    }
    
    //write and test a method that returns true if the sum of the letters for all the strings with an even amount of letters is greater than the sum of those with an odd
    //amount of letters
